        ...
        <div class="session-panels">
          ...
          <div class="session-panel">
            <div class="session-group-header">
              ...
              <button class="session-header-add-btn" @click="openConversationModal" :disabled="onlineAgentCount === 0" :title="$t('chat.sidebar.newConv')">
          ...
          <div class="session-panel">
            <div class="session-group-header">
              ...
              <button class="session-header-add-btn" @click="newCrewSession" title="New Crew">
                <svg viewBox="0 0 24 24" width="14" height="14"><path fill="currentColor" d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>
              </button>
            </div>
            <div class="session-panel-list">

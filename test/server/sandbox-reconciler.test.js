...
function config(overrides = {}) {
  return {
    ...
    hostAttestationListenerHost: '127.0.0.1',
    hostAttestationListenerPort: 9443,
    hostAttestationServerCert: 'test-server-cert',
    hostAttestationServerKey: 'test-server-key',
    hostAttestationClientCa: 'test-client-ca',
    hostAttestationBodyLimitBytes: 64 * 1024,
...
describe('sandbox reconciler', () => {
  ...
  it('dispatches persisted operations and applies fenced Controller results', async () => {
    ...
    expect(dispatched).toMatchObject({
      protocolVersion: 1,
      operationId: 'op-1', hostId: 'dedicated-1', sandboxId: 'sandbox-1', hostEpoch: 1,

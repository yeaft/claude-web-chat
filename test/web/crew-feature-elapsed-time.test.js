...
describe('structural integrity', () => {
  ...
  it('all test files use same CSS brace count', () => {
    ...
    expect(rmTestSource).toContain('expect(opens).toBe(2109)');
    ...
    expect(scrollTestSource).toContain('expect(opens).toBe(2109)');
    ...
    expect(kanbanTestSource).toContain('expect(opens).toBe(2109)');
  });
});

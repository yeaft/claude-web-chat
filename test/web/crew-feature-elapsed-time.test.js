...
describe('structural integrity', () => {
  it('CSS has balanced braces (2109/2109)', () => {
  ...
  it('all test files use same CSS brace count', () => {
    ...
    expect(scrollTestSource).toContain('expect(opens).toBe(2112)');
    ...
    expect(kanbanTestSource).toContain('expect(opens).toBe(2112)');
  });
});

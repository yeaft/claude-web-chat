...
describe('structural integrity', () => {
  ...
  it('all test files use same CSS brace count', () => {
    ...
    expect(scrollTestSource).toContain('expect(opens).toBe(2097)');
    ...
    expect(kanbanTestSource).toContain('expect(opens).toBe(2097)');
  });
});

...
describe('structural integrity', () => {
  ...
  it('all test files use same CSS brace count', () => {
    ...
    expect(rmTestSource).toContain('expect(opens).toBe(2092)');
    ...
    expect(scrollTestSource).toContain('expect(opens).toBe(2092)');
    ...
    expect(kanbanTestSource).toContain('expect(opens).toBe(2092)');
  });
});

...
describe('structural integrity', () => {
  ...
  it('all test files use same CSS brace count', () => {
    ...
    expect(scrollTestSource).toContain('expect(opens).toBe(2096)');
    ...
    expect(kanbanTestSource).toContain('expect(opens).toBe(2096)');
  });
});

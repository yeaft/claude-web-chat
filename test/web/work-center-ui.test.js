...
describe('Work Center UI contract', () => {
  ...
  it('uses progressive Work Item and Action workspaces with messages, lazy request detail, and input', () => {
    ...
    expect(detail).toContain('class="work-center-action-inspector"');
    expect(detail).toContain('work-center-action-owner');
    ...
    expect(detail).toContain('workCenter.actionInformation');
    expect(css).toContain('grid-template-columns: minmax(0, 1fr) minmax(250px, 320px)');
    expect(css).toContain('@container work-center (max-width: 980px)');
    ...
    expect(detail).toContain("$t('workCenter.messageExecutor'");
